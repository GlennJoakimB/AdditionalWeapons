...
public class ThrownBroadGlaiveModel extends Model {// EntityModel<ThrownBroadGlaive> {
  ...
  // ModelPartData Blade = modelPartData.addChild("Blade", ModelPartBuilder.create()
  // .uv(4, 0).cuboid(-0.75F, -5.5F, -1.25F, 0.5F, 9.5F, 3.0F, new Dilation(0.0F))
  ...
  // ModelPartBuilder.create().uv(11, 3).cuboid(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F)),
  ...
  // ModelPartBuilder.create().uv(0, 0).cuboid(-0.5F, -10.0F, -0.5F, 1.0F, 16.0F, 1.0F, new Dilation(0.0F)),
  // ModelTransform.pivot(0.0F, 24.0F, 0.0F));

  // ModelPartData SideHandle_r1 = Handle.addChild("SideHandle_r1",
  // ModelPartBuilder.create().uv(11, 10).cuboid(-0.7F, -3.0F, -0.75F, 1.0F, 6.0F, 1.0F, new Dilation(0.0F)),
  // ModelTransform.of(-0.05F, -7.0F, -0.5F, 0.0F, -0.7854F, 0.0F));

  // ModelPartData HandleBracket_r1 = Handle.addChild("HandleBracket_r1", ModelPartBuilder.create()
  // .uv(8, 0).cuboid(-1.35F, 2.25F, -1.35F, 2.0F, 1.0F, 2.0F, new Dilation(0.0F))
  // .uv(8, 0).cuboid(-1.35F, -4.75F, -1.35F, 2.0F, 1.0F, 2.0F, new Dilation(0.0F)),
